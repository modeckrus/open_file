# open_file_modeck
[![pub package](https://img.shields.io/pub/v/open_file_modeck.svg)](https://pub.dartlang.org/packages/open_file_modeck)
...
To use this plugin, add [open_file_modeck](https://pub.dartlang.org/packages/open_file_modeck#-installing-tab-) as a dependency in your pubspec.yaml file.
```yaml
dependencies:
  #androidx
  open_file_modeck: ^lastVersion 
  #support
  #open_file_modeck: ^1.3.0
```
